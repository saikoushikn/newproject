...
class ThrottledPromiseAll {
     ...
     */
    get results() {
        return __classPrivateFieldGet(this, _ThrottledPromiseAll_results, "f").sort((a, b) => (a?.index ?? 0) - (b?.index ?? 0)).map((r) => r?.result);
    }
    /**
    ...
    async dequeue() {
        ...
        while (this.queue.length > 0 || concurrencyPool.size > 0) {
            ...
            __classPrivateFieldGet(this, _ThrottledPromiseAll_results, "f").push(r);
        }
    }
}
